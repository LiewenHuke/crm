			...
			$.ajax({
				...
				success:function (data) {
					...
					if (data.success){
						...
						html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${requestScope.activity.name}</b> <small style="color: gray;" id="s'+data.ar.id+'"> '+(data.ar.createTime)+' 由'+(data.ar.createBy)+'</small>';
			...
			$.ajax({
				...
				success:function (data) {
					...
					if (data.success){
						...
						//更新div中相应的信息，需要更新的内容：noteContent、editTime、editBy
	...
	function deleteRemark(id) {
		...
		$.ajax({
			...
			success:function (data) {
				...
				if (data.success){
					//showRemarkList()是不行的，因为会动态拼上之前的字符串;
					$("#"+id).remove();
