...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#addBtn").click(function () {
			...
			/*
				操作模态窗口的方式：
					需要操作的模态窗口的jQuery对象，调用modal方法，为该方法传递参数 show：打开   hide：关闭
			 */
				...
				success:function (data) {
					if (data.success){
						...
						*/
						...
						//清空模态窗口中的数据（jquery对象没有reset方法，但是原生js有）
		...
		$("#searchBtn").click(function () {
			/*
				...
				点击查询按钮的时候，应该将搜索框的信息保存起来（保存到隐藏域中）
							...
							<div class="col-sm-10" style="width: 81%;">
								<%--
									关于文本域：
										...
										（2）textArea虽然是以标签对的形式来呈现的，但是它也属于表单元素
				...
				<div class="btn-group" style="position: relative; top: 18%;">
					<!--
						...
						data-target="#createActivityModel"
							表示要打开哪一个模态窗口，通过#id的形式找到该窗口

						现在我们是以属性和属性值的方式写在了button元素中，用来打开模态窗口
						但是这样是有问题的：
							在于没有办法对于按钮的功能进行扩充

						所以对于触发模态窗口的操作，一定不要写死在元素当中，应该有自己写js代码来操控。
