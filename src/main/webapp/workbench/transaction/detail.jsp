...
<%@ page import="com.gsy.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.gsy.crm.workbench.domain.Tran" %>
	...
	function changeStage(stage,i) {
		...
		$.ajax({
			...
			success:function (data) {
				...
				if (data.success){
					//改变阶段成功后，需要在详细信息页上局部刷新：阶段、可能性、修改人以及修改时间
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		%>
						<span id="<%=i%>" onclick="changeStage('<%=listStage%>','<%=i%>')"
							  class="glyphicon glyphicon-map-marker mystage mystage"
							  data-toggle="popover" data-placement="bottom"
