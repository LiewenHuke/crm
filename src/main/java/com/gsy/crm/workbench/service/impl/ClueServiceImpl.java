...
import com.gsy.crm.workbench.dao.*;
import com.gsy.crm.workbench.domain.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        for (ClueActivityRelation clueActivityRelation:clueActivityRelationList){
            ...
            //创建联系人与市场活动的关联关系列表，让第三步生成的联系人与市场活动做关联
        ...
        if (t!=null){
            /*
                ...
                t对象再controller里面已经封装好的信息：
                    id,money,name,expectedDate,stage,activityId,createBy,createBy,createBy
                通过第一步生成的c对象，取出一些信息，继续完善堆t对象的封装
             */
